...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/throbbing-band-257f)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/throbbing-band-257f
```

A live public deployment of this template is available at [https://throbbing-band-257f.templates.workers.dev](https://throbbing-band-257f.templates.workers.dev)
